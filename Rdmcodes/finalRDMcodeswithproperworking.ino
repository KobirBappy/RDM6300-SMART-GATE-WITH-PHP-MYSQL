...
SoftwareSerial RFID(D7, D6); // rx/D6 - TX (RFID), tx/D5 - RX (RFID)


/* Set these to your desired credentials. */
const char *ssid = "Kabir PC";
const char *password = "123456789";
//const char *ssid = "Bappy";
//const char *password = "01727507239";
const char* device_token  = "ca8a6ad50a8ea345";
//************************************************************************
String URL = "http://192.168.31.154:80//rfidattendancerdm/getdata.php"; //computer IP or the server domain
String getData, Link;
String OldCardID = "";
String CardID ="";
...
String CardNumber[] = {"8438555", "5958741"};
...
void loop() {
  if(!WiFi.isConnected()){
    connectionWiFi();    //Retry to connect to Wi-Fi
  }
